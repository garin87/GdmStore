...
namespace GdmStore.Migrations
{
    ...
    [Migration("20190307104713_edit-seed-method2")]
    partial class editseedmethod2
    {
            ...
            modelBuilder.Entity("GdmStore.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new { ProductId = 1L, Amount = 6.04, Name = "Шток хромированный", Number = "50-E-1", PrimeCostEUR = 34.65, ProductParameterId = 0L, ProductTypeId = 1L },
                        new { ProductId = 2L, Amount = 6.84, Name = "Шток хромированный", Number = "50-V2-1", PrimeCostEUR = 39.87, ProductParameterId = 0L, ProductTypeId = 1L },
                        new { ProductId = 3L, Amount = 7.24, Name = "Труба хонингованная", Number = "80*95-E-4", PrimeCostEUR = 25.85, ProductParameterId = 0L, ProductTypeId = 2L }
                    );
                });
