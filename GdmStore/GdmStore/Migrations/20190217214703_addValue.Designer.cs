...
namespace GdmStore.Migrations
{
    ...
    [Migration("20190217214703_addValue")]
            ...
            modelBuilder.Entity("GdmStore.Models.Parameter", b =>
                {
                    ...
                    b.HasData(
                        new { ParameterId = 1L, Diameter = 0, Name = "H9", ProductTypeId = 1L },
                        new { ParameterId = 2L, Diameter = 0, Name = "ТВЧ", ProductTypeId = 1L }
                    );
                });
